    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client', 'Клиент'), ('trainer', 'Хореограф'), ('admin', 'Администратор')], default='client', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('styles', models.ManyToManyField(related_name='trainers', to='main.dancestyle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dance_style', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.dancestyle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('booked', 'Записан'), ('attended', 'Посещено'), ('missed', 'Не пришел'), ('cancelled', 'Отменено')], default='booked', max_length=10)),
